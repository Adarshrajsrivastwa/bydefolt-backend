...
const jobPostSchema = new mongoose.Schema(
  {
    ...
    workplace: { type: String, trim: true, maxlength: 80, default: 'Hybrid' },
    employmentType: { type: String, trim: true, maxlength: 80, default: 'Full-time' },
    experienceMin: { type: Number, min: 0, max: 40, default: null },
    experienceMax: { type: Number, min: 0, max: 40, default: null },
    salaryMinLpa: { type: Number, min: 0, max: 200, default: null },
    salaryMaxLpa: { type: Number, min: 0, max: 200, default: null },
